...
export async function onRequestPost({ request, env }) {
  ...
  const isApplication = Boolean(jobTitle || hasCv);
  ...
  return json({
    ok: true,
    message: isApplication ? 'Application submitted successfully' : 'Enquiry submitted successfully',
  });
}
